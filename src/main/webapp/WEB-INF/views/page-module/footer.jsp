<footer>
	<div class="container">
		<div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms"
			...
			<h4>About Us</h4>
			<p>Anyar is tellus ac cursus commodo, mauesris condime ntum nibh,
		...
		<div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms"
			...
			<div class="">
				...
				<p>Subscribe today to receive the latest Corpboot news via
...
<div class="sub-footer">
	<div class="container">
		...
		<div class="col-md-4 col-md-offset-4">
			<div class="copyright">
				&copy; Anyar 2015 by <a target="_blank"
					href="http://bootstraptaste.com/"
					title="Free Twitter Bootstrap WordPress Themes and HTML templates">bootstraptaste</a>.All
				Rights Reserved.
			</div>
		</div>
	</div>
